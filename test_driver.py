...
class SparkyHardwareNode(Node):
    def __init__(self):
        ...
        # Test connexion I2C (ligne 5-11 de test_driver.py)
        try:
        ...
        # Créer les 18 servos (ligne 13-31 de test_driver.py)
        ...
        # Position neutre au démarrage (ligne 35-36 de test_driver.py)
        ...
        # Reproduire le test de test_driver.py (ligne 40-42)
    ...
    def destroy_node(self):
        """Nettoyage à la fermeture (ligne 45-48 de test_driver.py)"""
